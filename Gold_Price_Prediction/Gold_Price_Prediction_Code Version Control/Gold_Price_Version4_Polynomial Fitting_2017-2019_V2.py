...
##############################################################################
#  7) Train & Evaluate & Save Extended Predictions
##############################################################################
def train_and_evaluate(model_type):
    ...
    3) Save best model checkpoint + predictions in 'extended_prediction_best_model_<model_type>.pt'.
    ...
    # 4) Save everything (model + predictions + best_params) in an extended file
    ...
    print(f"Saved best {model_type} model + predictions to {extended_pred_path}")
...
##############################################################################
#  8) Run Training/Evaluation for All Models
##############################################################################
...
##############################################################################
#  9) Zoomed-in Plot of Predictions on Validation + Test
##############################################################################
model_colors = {
    'LSTM': 'red',
    'GRU': 'blue',
